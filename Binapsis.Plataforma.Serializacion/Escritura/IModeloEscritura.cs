...
namespace Binapsis.Plataforma.Serializacion.Escritura
{
	internal interface IModeloEscritura
    {
        ...
        /// </summary>
		IMetodoEscritura Crear(ObjetoDatos od);
        ...
        /// </summary>
        IMetodoEscritura Crear(ObjetoDatos propietario, IPropiedad propiedad);
        ...
        /// </summary>
        IMetodoEscritura Crear(ObjetoDatos propietario, IPropiedad propiedad, int indice);
    }
