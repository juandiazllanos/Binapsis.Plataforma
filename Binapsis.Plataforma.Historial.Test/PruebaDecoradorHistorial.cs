...
using static Binapsis.Plataforma.Historial.Test.Helper;
using Binapsis.Plataforma.Estructura.Impl;

namespace Binapsis.Plataforma.Historial.Test
{
    [TestClass]
    public class PruebaDecoradorHistorial
    {
        [TestMethod]
        public void Probar_Historial_ObjetoDatos_Deshacer()
        {
            // arrange
            Log controlador = new Log();
            //FabricaHistorial fabrica = new FabricaHistorial();
            IFabrica fabrica = new FabricaHistorial(controlador);
            IObjetoDatos od = fabrica.Crear(ConstruirTipo());
        ...
        [TestMethod]
        public void Probar_Historial_ObjetoDatosComplejo_Deshacer()
        {
            // arrange
            Log controlador = new Log();
            //FabricaHistorial fabrica = new FabricaHistorial();
            IFabrica fabrica = new FabricaHistorial(controlador);
            IObjetoDatos od = fabrica.Crear(ConstruirTipoComplejo());
        ...
        [TestMethod]
        public void Probar_Historial_ObjetoDatos_Recuperar()
        {
            // arrange
            Log log = new Log();
            //FabricaHistorial fabrica = new FabricaHistorial();
        ...
        [TestMethod]
        public void Probar_Historial_ObjetoDatosComplejo_Recuperar()
        {
            // arrange
            Log log = new Log();
